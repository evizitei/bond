...
== Developer tips
If you want to help contribute to this project, here are a few pointers that will help you out when setting it up in your development environment:

* Clone the repo
* You will need the "bacon" testing library installed (it's a small version of RSpec)
* You will also need the version of mocha written to work with bacon (aptly titled "mocha-on-bacon")
* use "rake test" to kick off the test library.  Good to go!

  git clone http://github.com/cldwalker/bond.git
